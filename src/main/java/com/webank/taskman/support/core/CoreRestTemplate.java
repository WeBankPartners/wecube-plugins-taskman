...
public class CoreRestTemplate {
    ...
    @Autowired
    ServiceTaskmanProperties taskmanProperties;
    ...
    public <D, R extends CoreResponse> D postForResponse(String targetUrl, Object postObject, Class<R> responseType) throws CoreRemoteCallException
    {
        log.info("{}About to POST {} with postObject {}", taskmanProperties.getVersion(),targetUrl, postObject.toString());
