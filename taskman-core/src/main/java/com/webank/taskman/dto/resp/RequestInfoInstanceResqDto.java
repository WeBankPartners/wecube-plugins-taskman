...
public class RequestInfoInstanceResqDto {
    private String id;
    ...
    private FormInfoResqDto requestFormResq;

    private List<TaskInfoInstanceRespDto> taskInfoInstanceResps;
    ...
    public FormInfoResqDto getRequestFormResq() {
        return requestFormResq;
    }

    public void setRequestFormResq(FormInfoResqDto requestFormResq) {
        this.requestFormResq = requestFormResq;
    }

    public List<TaskInfoInstanceRespDto> getTaskInfoInstanceResps() {
        return taskInfoInstanceResps;
    }

    public void setTaskInfoInstanceResps(List<TaskInfoInstanceRespDto> taskInfoInstanceResps) {
        this.taskInfoInstanceResps = taskInfoInstanceResps;
    }

    @Override
    public String toString() {
        return new StringJoiner(", ", RequestInfoInstanceResqDto.class.getSimpleName() + "[", "]")
                .add("id='" + id + "'")
