...
func init() {
	httpHandlerFuncList = append(httpHandlerFuncList,
		...
		&handlerFuncObj{Url: "/form-template/item-group", Method: "GET", HandlerFunc: form.GetFormTemplateItemGroup},
		...
		&handlerFuncObj{Url: "/form-template/item-group/custom-data-update", Method: "POST", HandlerFunc: form.UpdateFormTemplateItemGroupCustomData},
