...
public interface FormTemplateService extends IService<FormTemplate> {
    QueryResponse<FormTemplateResp> selectFormTemplate(Integer current, Integer limit, FormTemplateSaveReqDto req);

    void deleteFormTemplate(String id);

    FormTemplateResp detailFormTemplate(FormTemplateSaveReqDto saveFormTemplateReq);

    FormTemplateResp saveFormTemplateByReq(FormTemplateSaveReqDto formTemplateReq);
