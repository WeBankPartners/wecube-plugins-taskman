...
public class ControllerLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        try {
            ...
            if(printResult){
                logs.append(String.format(jsonKey,"respone")).append(GsonUtil.GsonString(result)).append(",");
            }
            logs.append(String.format(jsonKey,"returnClass")).append(result.getClass().getName());
            logs.append("\n}");
