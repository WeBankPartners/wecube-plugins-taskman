...
public class TestAutoGenerate {
    ...
    public void autoGenerate() {
        ...
        // 填写代码生成的目录(需要修改)
        String projectPath = "D:\\workspace\\wecube-plugins-taskman";
        // 拼接出代码最终输出的目录
...
//        gc.setAuthor("lyh");
        ...
        // 配置数据库 url 地址
        dsc.setUrl("jdbc:mysql://106.52.160.142:13307/service_mgmt?characterEncoding=utf8&serverTimezone=Asia/Shanghai");
