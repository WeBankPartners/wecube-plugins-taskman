 ...
 * @LastEditTime: 2025-03-03 17:45:35
 *
...
const WRITE_API_PATH = path.resolve(path.resolve('..'), 'taskman-server/conf') // api-menu-config.json文件写入的路径
...
const menuPathMap = {
  'TASK_WORKBENCH': [
    ...
    'src/pages/workbench/template/index.vue',
    'src/pages/workbench/publish/create',
    'src/pages/workbench/publish/detail',
    'src/pages/workbench/publish/list',
    'src/pages/workbench.vue'
  ],
  'TASK_TEMPLATE_MANAGEMENT': [
    'src/pages/template.vue',
    'src/pages/temp-management/index.vue'
  ],
  'TASK_TEMPLATE_GROUP_MANAGEMENT': [
    'src/pages/template-group.vue'
  ],
  'TASK_REQUEST_AUDIT': [
